...
import type {
	PostServiceClient as _furink_posts_PostServiceClient,
	PostServiceDefinition as _furink_posts_PostServiceDefinition,
} from "./furink/posts/PostService";
import type {
...
export interface ProtoGrpcType {
	furink: {
		posts: {
			...
			PostService: SubtypeConstructor<
				typeof grpc.Client,
				_furink_posts_PostServiceClient
			> & { service: _furink_posts_PostServiceDefinition };
